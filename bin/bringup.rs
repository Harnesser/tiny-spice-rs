...
fn build_002() -> circuit::Circuit {
    ...
    ckt.elements.push(
        circuit::Element::R(circuit::Resistor{a: 1, b: 2, value: 10.0}),
    );
    ckt.elements.push(
        circuit::Element::R(circuit::Resistor{a: 2, b: 3, value: 10.0}),
    );
    ckt.elements.push(
        circuit::Element::R(circuit::Resistor{a: 2, b: 0, value: 5.0}),
    );
    ckt.elements.push(
        circuit::Element::R(circuit::Resistor{a: 3, b: 0, value: 5.0}),
    );
    ckt
}
